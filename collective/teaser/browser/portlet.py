...
class ITeaserPortlet(IPortletDataProvider):
    ...
    display_columns = schema.Choice(
        title=_(
            u'portlet_label_display_columns',
            default=u'Number of columns'
        ),
        description=_(
            u'portlet_help_display_columns',
    ...
    importance_levels = schema.Tuple(
        title=_(
            u'portlet_label_importance_levels',
            default=u'Importance Levels'
        ),
        description=_(
            u'portlet_help_importance_levels',
            default=u'Select which importance levels the portlet should show.'
        ),
    ...
    keywords_filter = schema.Tuple(
        title=_(
            u'portlet_label_keywords_filter',
            default=u'Keywords Filter'
        ),
        description=_(
            u'portlet_help_keywords_filter',
            default=u'Select which teasers with specific keywords should be '
                    u'shown. Select none to order to show any teasers.'
            ),
        default=None,
        required=False,
        value_type=schema.Choice(
    ...
    teaser_scale = schema.Choice(
        title=_(
            u'portlet_label_image_scale',
            default=u'Image Scale'
        ),
        description=_(
            u'portlet_help_image_scale',
            default=u'Select image used by portlet.'
        ),
        required=True,
        default=None,
    ...
    num_teasers = schema.Int(
        title=_(
            u'portlet_label_num_teasers',
            default=u'Number of teasers'
        ),
        description=_(
            u'portlet_help_num_teasers',
            default=u'Define the maximum number of teasers, which are'
                    u'displayed in this portlet'),
        default=1,
        required=True,
    )
    ...
    ajaxified = schema.Bool(
        title=_(
            u'portlet_label_ajaxified',
            default=u'Load Teasers via AJAX?'
        ),
        description=_(
            u'portlet_help_ajaxified',
            default=u'Whether teaser is loaded deferred via ajax or directly.'
        ),
        default=True,
        required=False,
    )
    ...
    show_description = schema.Bool(
        title=_(
            u'portlet_label_show_description',
            default=u'Show description'
        ),
        description=_(
            u'portlet_help_show_description',
            default=u'Show the description of the teaser as text below image.'
        ),
        default=False,
        required=False,
    )
...
class AddForm(base.AddForm):
    ...
    description = _(
        u'portlet_help_add',
        default=u"This portlet shows teasers."
    )
